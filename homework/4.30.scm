;; a) 因为begin的每个函数体都会通过eval执行，而display是一个 primitive procedure

;; b) 修改前 (p1 1) -> (1 2) (p2 1) -> 1
;; b) 修改后 (p1 1) -> (1 2) (p2 1) -> (1 2)

;; c) 修改后 actual-value 会判断是否为 thunk，如果不是则执行原先的那套规则，不影响
;; d) 喜欢 4.31 那种方式
